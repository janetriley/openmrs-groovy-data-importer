...
class AHCOpdEncounterSourceTest {

	AHCOpdEncounterSource mySource = null;
	...
	public void setUp() throws Exception {
		mySource = new AHCOpdEncounterSource(filepath);
	}
	...
	public void testGet() {
		...
		mySource = new AHCOpdEncounterSource(reader);
		mySource.next();
