...
class PatientUpdate1Test extends BaseContextSensitiveTest {
    ...
    String TEST_DATA_FILE = "/Volumes/ETUI/prod_exports/sept_exports/patients/patient_sample.txt"
    BasePatientImporter imp = null;

    @Before
    public void setUp() throws Exception {
	imp = new PatientUpdate1();
    }
