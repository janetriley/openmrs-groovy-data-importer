...
class PatientImporter  {
	...
	def initSource(String filepath){
		def source = new AHCMainPatientSource(filepath);
	...
	void importPatients(String filepath){
		...
		def source = new org.openmrs.tools.importer.source.AHCMainPatientSource(filepath);
		def factory = new AHCPatientAssembler( source:source);
		def importCounter = 0;
